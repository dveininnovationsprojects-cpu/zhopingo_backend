...
/* =====================================================
   🔐 PHONEPE SDK INITIALIZATION (ONLY ONCE)
===================================================== */
...
const createDelhiveryShipment = async (order, phone) => {
  try {
    const shipmentData = {
      shipments: [
        {
    ...
    console.log("Delhivery Error:", err.message);
    return null;
  }
};

/* =====================================================
   ✅ UPDATE ORDER SUCCESS (COMMON FUNCTION)
===================================================== */
...
const markOrderAsPaid = async (orderId) => {
  ...
  if (shipment?.packages?.length > 0) {
    order.awbNumber = shipment.packages[0].waybill;
  }
...
exports.createSession = async (req, res) => {
  try {
    ...
    const request = StandardCheckoutPayRequest.builder()
      ...
      .amount(Math.round(order.totalAmount * 100))
      .redirectUrl(
        `${process.env.BASE_URL}/api/v1/payments/phonepe-return/${orderId}`
      )
      .build();
...
/* =====================================================
   2️⃣ VERIFY PAYMENT (Manual Verify API)
===================================================== */
...
/* =====================================================
   3️⃣ PHONEPE RETURN (DEEPLINK REDIRECT)
===================================================== */
...
/* =====================================================
   4️⃣ WEBHOOK (REAL-TIME CONFIRMATION)
===================================================== */
